...
#if GLIB_VERSION_MIN_REQUIRED >= GLIB_VERSION_2_53
# define GLIB_DEPRECATED_IN_2_53                GLIB_DEPRECATED
# define GLIB_DEPRECATED_IN_2_53_FOR(f)         GLIB_DEPRECATED_FOR(f)
#else
# define GLIB_DEPRECATED_IN_2_53                _GLIB_EXTERN
# define GLIB_DEPRECATED_IN_2_53_FOR(f)         _GLIB_EXTERN
#endif

#if GLIB_VERSION_MAX_ALLOWED < GLIB_VERSION_2_53
# define GLIB_AVAILABLE_IN_2_53                 GLIB_UNAVAILABLE(2, 53)
#else
# define GLIB_AVAILABLE_IN_2_53                 _GLIB_EXTERN
#endif
